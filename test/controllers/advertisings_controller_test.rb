...
class AdvertisingsControllerTest < ActionController::TestCase
  ...
  test "should create advertising" do
    assert_difference('Advertising.count') do
      post :create, advertising: { Description: @advertising.Description, ImageUrl: @advertising.ImageUrl, Title: @advertising.Title }
    end
  ...
  test "should update advertising" do
    patch :update, id: @advertising, advertising: { Description: @advertising.Description, ImageUrl: @advertising.ImageUrl, Title: @advertising.Title }
    assert_redirected_to advertising_path(assigns(:advertising))
  end
