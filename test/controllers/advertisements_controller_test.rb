...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { Description: @advertisement.Description, DisplayTime: @advertisement.DisplayTime, ImageUrl: @advertisement.ImageUrl, Title: @advertisement.Title }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { Description: @advertisement.Description, DisplayTime: @advertisement.DisplayTime, ImageUrl: @advertisement.ImageUrl, Title: @advertisement.Title }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
